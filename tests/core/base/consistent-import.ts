          ...
          sources: [
            {
              ...
              localName: "source",
              source: "eslint-plugin-misc/src/source",
              wildcard: true
            }
          ]
        }
      ...
      options: [
        {
          sources: [
            {
              _id: "id1",
              source: "eslint-plugin-misc/source1",
              wildcard: true
            },
            {
              _id: "id2",
              source: "eslint-plugin-misc/fixtures/source2",
              wildcard: true
            },
      ...
      errors: [
        ...
        },
        {
          ...
          data: {
            ...
            source: "eslint-plugin-misc/fixtures/source3"
          }
        }
      ]
    },
          ...
          sources: [
            {
              _id: "id0",
              localName: "index",
              source: "eslint-plugin-misc",
              wildcard: true
            },
            {
              _id: "id1",
              source: "eslint-plugin-misc/src/source1",
              wildcard: true
            },
            {
              _id: "id2",
            ...
            { _id: "id3", source: "eslint-plugin-misc/source3", wildcard: true }
          ]
        }
      ],
      code: `
      ...
      options: [
        {
          sources: [
            {
              _id: "id",
              source: "eslint-plugin-misc/src/some-source",
              wildcard: true
            }
          ]
        }
