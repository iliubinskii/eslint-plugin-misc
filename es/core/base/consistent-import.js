        ...
        function lintConsistentImport() {
            for (const node of importDeclarations) {
                ...
                if (suboptions) {
                    ...
                    const wildcardSpecifier = node.specifiers.find(candidate => candidate.type === AST_NODE_TYPES.ImportNamespaceSpecifier);
                    const defaultSpecifier = node.specifiers.find(candidate => candidate.type === AST_NODE_TYPES.ImportDefaultSpecifier);
                    if (wildcard)
