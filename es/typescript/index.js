...
export const typescript = o.prefixKeys(Object.assign(Object.assign({}, base), { "class-methods-use-this": classMethodsUseThis, "consistent-array-type-name": consistentArrayTypeName, "define-function-in-one-statement": defineFunctionInOneStatement, "no-boolean-literal-type": noBooleanLiteralType, "no-complex-declarator-type": noComplexDeclaratorType, "no-complex-return-type": noComplexReturnType, "no-empty-interfaces": noEmptyInterfaces, "no-never": noNever, "no-unsafe-object-assign": noUnsafeObjectAssign, "prefer-array-type-alias": preferArrayTypeAlias, "prefer-class-method": preferClassMethod, "prefer-readonly-array": preferReadonlyArray, "prefer-readonly-map": preferReadonlyMap, "prefer-readonly-property": preferReadonlyProperty, "prefer-readonly-set": preferReadonlySet, "require-prop-type-annotation": requirePropTypeAnnotation, "require-this-void": requireThisVoid }), "typescript/");
